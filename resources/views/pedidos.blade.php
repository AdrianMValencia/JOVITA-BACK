    ...
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12 text-center" style="font-size: 13px; text-align: center;">
                <strong class="text-uppercase">{{ $pedidos->puntoventa }}</strong> <br />
                ...
                <div style="font-size: 8px;margin: 0px; padding: 0px">PEDIDO {{ str_pad($pedidos->id,4,"0",STR_PAD_LEFT) }}</div>
            </div>

            <div class="col-lg-12">
                <table style="width: 100%;">
                    <tr>
                        <td colspan="2" style="font-size: 8px; text-align: right;">{{ date("d/m/Y h:m", strtotime($pedidos->created_at)) }}</td>
                    </tr>
                    <tr>
                        <td style="font-size: 8px; width: 30%;"><strong>CAJERO: </strong></td>
                        <td style="font-size: 8px; width: 70%;">{{ $pedidos->vendedor }}</td>
                    </tr>
                    <tr>
            ...
            <div class="col-lg-12">
                <table class="table" width="100" style="width: 100%;">
                    ...
                    @foreach ($pedidos->detalles as $item)
                    <tr>
            ...
            <div class="col-lg-12 mt-4 text-right">
                <table width="100" style="width: 100%;">
                    <tr>
                        ...
                        <td style="font-size:10px;text-align: right;width: 30%;">{{ number_format($pedidos->total, 2) }}</td>
                    </tr>
                </table>
            </div>
            <br>
